...
const Tree = forwardRef<HTMLDivElement, TreeViewProps>(
  (
    ...
    const expandSpecificTargetedElements = useCallback(
      (elements?: Folder[], selectId?: string) => {
        ...
        const findParent = (
          ...
          const newPath = [...currentPath, String(currentElement.id)];
          if (String(currentElement.id) === selectId) {
            // if (isSelectable) {
              setExpandedItems((prev) => [...(prev ?? []), ...newPath.filter((id): id is string => typeof id === 'string')]);
            // } else {
    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-blue-400": isSelected && isSelectable,
          },
